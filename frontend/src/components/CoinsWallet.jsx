...
const CoinsWallet = () => {
  ...
  return (
    <div
      ...
      className='gap-1 flex items-center bg-gradient-to-r from-yellow-400 to-orange-500 px-2 py-1 sm:px-3 sm:py-2 rounded-full cursor-pointer hover:from-yellow-500 hover:to-orange-600 transition-all duration-300 shadow-md hover:shadow-lg'
    >
