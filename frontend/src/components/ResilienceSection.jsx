const ResilienceSection = () => {
  return (
    <div className="relative text-center rounded-t-[100%] py-32 px-6 mt-20 
      bg-gradient-to-b from-green-600 via-green-400 via-green-300 to-background text-gray-900">
      ...
      <div className="flex items-end justify-center min-h-[200px]">
        <h2 className="text-3xl md:text-4xl font-semibold leading-snug max-w-2xl mx-auto">
          ...
          with <span className="font-bold text-[#463830]">Sofia Therapy 🌼🌸</span> <br />
